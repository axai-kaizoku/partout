					...
					<div className="flex-1 space-y-4">
						<div>
							<div className="flex items-center gap-3 mb-2">
								<h1 className="font-playfair text-2xl font-bold text-foreground capitalize">
									{user?.name}
								</h1>
						...
						<div className="flex sm:items-center items-start gap-4 text-sm text-muted-foreground sm:flex-row flex-col">
